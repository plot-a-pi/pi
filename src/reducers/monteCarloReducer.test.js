...
import { add1Dart, add10Darts, add100Darts, add1000Darts, clearDarts } from '../actions/monteCarloActions.js';
...
describe('monteCarlo reducer', () => {
  ...
  it('handles the CLEAR_DARTS case', () => {
    ...
    const newState = reducer(initialState, action);
    expect(newState).toEqual({ dartsTotal: 0, circleTotal: 0, dartsArray: [], piApproximation: null, piApproximationsArray: [], yMax: 4 });
  });
});
